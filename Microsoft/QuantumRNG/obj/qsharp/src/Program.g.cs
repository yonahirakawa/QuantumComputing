...
{
    [SourceLocation("C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs", OperationFunctor.Body, 9, 19)]
...
#line hidden
            {
#line 11 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 13 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 16 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs", OperationFunctor.Body, 19, 32)]
    public partial class SampleRandomNumberInRange : Operation<Int64, Int64>, ICallable
    {
        ...
        {
            var max = __in__;
#line 20 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 21 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 22 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
                var bits = new QArray<Result>();
#line 23 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 24 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 26 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
...
#line 28 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs", OperationFunctor.Body, 32, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 33 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
            var max = 50L;
#line 34 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between 0 and {0}: ", max));
#line 35 "C:\\Users\\BlueShift\\git\\QuantumComputing\\Microsoft\\QuantumRNG\\Program.qs"
